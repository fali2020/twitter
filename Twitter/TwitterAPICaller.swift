...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "8aZsBD2WHExYzi1L0OdGjS1ki", consumerSecret: "S8aef80HlT11wZTV0hwvT9HfYzZKxOBe8J3xi2dkOdyNTl17u1")
    var loginSuccess: (() -> ())?
